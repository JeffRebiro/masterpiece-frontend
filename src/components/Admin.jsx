                ...
                <tbody>
                  {categories.map(category => (
                    <tr key={category.id}>
                      ...
                      <td className="action-buttons">
                        <button className="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#categoryModal">
                          <i className="fas fa-edit"></i>
                        </button>
                        <button className="btn btn-sm btn-danger">
                          <i className="fas fa-trash"></i>
                ...
                <tbody>
                  {users.map(user => (
                    <tr key={user.id}>
                      <td>
                        <img 
                          src={user.avatar || `https://via.placeholder.com/40/4e73df/ffffff?text=${user.name.charAt(0)}`} 
                      ...
                      <td className="action-buttons">
                        <button className="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#userModal">
                          <i className="fas fa-edit"></i>
                        </button>
                        <button className="btn btn-sm btn-danger">
                          <i className="fas fa-trash"></i>
