...
const Admin = () => {
  ...
  // fetch categories for dropdown once logged in
  useEffect(() => {
    if (isLoggedIn) {
  ...
  const renderFormField = (field) => {
    ...
    // special case: dropdown for product category
                        ...
                        {items.map((item, index) => (
                          <tr key={item.id || index}>
                            ...
                            <td className="actions">
                              <button className="view-btn" onClick={() => setViewingItem(item)} disabled={loading}>
                                View
                              </button>
